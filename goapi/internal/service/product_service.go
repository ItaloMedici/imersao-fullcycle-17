...
func (productService *ProductService) GetProductByID(id string) (*entity.Product, error) {
...
func (productService *ProductService) GetProductsByCategory(categoryID string) ([]*entity.Product, error) {
	products, err := productService.ProductDB.GetProductsByCategory(categoryID)
